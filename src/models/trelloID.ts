...
/**
 * @deprecated Use `z.string()` directly. `TrelloID` is kept only for backward compatibility with code that imported
 *   it from the public API — the generated codebase no longer references it internally.
 */
