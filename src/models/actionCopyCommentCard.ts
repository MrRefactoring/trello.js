...
import { ActionDataCardRefSchema } from '#/models/actionDataCardRef';
...
export const ActionCopyCommentCardSchema = apiObject({
  id: z.string(),
  idMemberCreator: z.string(),
  data: apiObject({
    cardSource: ActionDataCardRefSchema,
    idOriginalCommenter: z.string(),
    text: z.string(),
    card: ActionDataCardSchema,
    board: ActionDataBoardSchema,
  }),
  type: z.enum(['copyCommentCard']),
  date: z.coerce.date(),
...
export type ActionCopyCommentCard = z.infer<typeof ActionCopyCommentCardSchema>;
