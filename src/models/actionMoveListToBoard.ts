...
export const ActionMoveListToBoardSchema = apiObject({
  id: z.string(),
  idMemberCreator: z.string(),
  data: apiObject({
    list: ActionDataListSchema,
    boardSource: ActionDataBoardRefSchema,
    board: ActionDataBoardSchema,
    member: ActionDataMemberSchema,
  }),
  type: z.enum(['moveListToBoard']),
  date: z.coerce.date(),
...
export type ActionMoveListToBoard = z.infer<typeof ActionMoveListToBoardSchema>;
