...
import { ActionDataOrganizationSchema } from '#/models/actionDataOrganization';
import { ActionDataOrganizationOldSchema } from '#/models/actionDataOrganizationOld';
import { LimitsSchema } from '#/models/limits';
import { MemberSchema } from '#/models/member';

export const ActionUpdateOrganizationSchema = apiObject({
  id: z.string(),
  idMemberCreator: z.string(),
  data: apiObject({
    organization: ActionDataOrganizationSchema,
    old: ActionDataOrganizationOldSchema,
  }),
  type: z.enum(['updateOrganization']),
  date: z.coerce.date(),
...
export type ActionUpdateOrganization = z.infer<typeof ActionUpdateOrganizationSchema>;
