...
export const ActionDeleteCardSchema = apiObject({
  id: z.string(),
  idMemberCreator: z.string(),
  data: apiObject({
    card: ActionDataCardRefSchema,
    list: ActionDataListSchema,
    board: ActionDataBoardSchema,
  }),
  type: z.enum(['deleteCard']),
  date: z.coerce.date(),
...
export type ActionDeleteCard = z.infer<typeof ActionDeleteCardSchema>;
