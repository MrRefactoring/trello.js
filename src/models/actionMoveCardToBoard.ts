...
export const ActionMoveCardToBoardSchema = apiObject({
  id: z.string(),
...
export type ActionMoveCardToBoard = z.infer<typeof ActionMoveCardToBoardSchema>;
