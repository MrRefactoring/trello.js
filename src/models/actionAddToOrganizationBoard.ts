...
export const ActionAddToOrganizationBoardSchema = apiObject({
  id: z.string(),
  ...
  type: z.enum(['addToOrganizationBoard']),
  date: z.coerce.date(),
...
export type ActionAddToOrganizationBoard = z.infer<typeof ActionAddToOrganizationBoardSchema>;
