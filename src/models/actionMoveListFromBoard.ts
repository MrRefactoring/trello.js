...
export const ActionMoveListFromBoardSchema = apiObject({
  id: z.string(),
...
export type ActionMoveListFromBoard = z.infer<typeof ActionMoveListFromBoardSchema>;
