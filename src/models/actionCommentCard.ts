...
import { ActionDataTextDataSchema } from '#/models/actionDataTextData';
...
export const ActionCommentCardSchema = apiObject({
  id: z.string(),
  idMemberCreator: z.string(),
  data: apiObject({
    idCard: z.string().optional(),
    idAuthor: z.string().optional(),
    text: z.string(),
    textData: ActionDataTextDataSchema,
    card: ActionDataCardSchema,
    board: ActionDataBoardSchema,
    list: ActionDataListSchema,
    dateLastEdited: z.string().optional(),
  }),
  type: z.enum(['commentCard']),
  date: z.coerce.date(),
...
export type ActionCommentCard = z.infer<typeof ActionCommentCardSchema>;
