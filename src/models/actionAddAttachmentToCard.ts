...
import { ActionDataAttachmentSchema } from '#/models/actionDataAttachment';
...
export const ActionAddAttachmentToCardSchema = apiObject({
  id: z.string(),
  idMemberCreator: z.string(),
  data: apiObject({
    attachment: ActionDataAttachmentSchema,
    card: ActionDataCardSchema,
    board: ActionDataBoardSchema,
    list: ActionDataListSchema.optional(),
  }),
  type: z.enum(['addAttachmentToCard']),
  date: z.coerce.date(),
...
export type ActionAddAttachmentToCard = z.infer<typeof ActionAddAttachmentToCardSchema>;
