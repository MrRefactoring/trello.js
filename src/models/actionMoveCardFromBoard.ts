...
import { ActionDataBoardRefSchema } from '#/models/actionDataBoardRef';
import { ActionDataListSchema } from '#/models/actionDataList';
import { ActionDataMemberSchema } from '#/models/actionDataMember';
import { LimitsSchema } from '#/models/limits';
import { MemberSchema } from '#/models/member';

export const ActionMoveCardFromBoardSchema = apiObject({
  id: z.string(),
  idMemberCreator: z.string(),
  data: apiObject({
    card: ActionDataCardSchema,
    board: ActionDataBoardSchema,
    boardTarget: ActionDataBoardRefSchema,
    list: ActionDataListSchema,
    member: ActionDataMemberSchema,
  }),
  type: z.enum(['moveCardFromBoard']),
  date: z.coerce.date(),
...
export type ActionMoveCardFromBoard = z.infer<typeof ActionMoveCardFromBoardSchema>;
