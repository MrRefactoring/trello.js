...
import { ActionDataCardOldSchema } from '#/models/actionDataCardOld';
...
export const ActionUpdateCardSchema = apiObject({
  id: z.string(),
  idMemberCreator: z.string(),
  data: apiObject({
    old: ActionDataCardOldSchema,
    card: ActionDataCardSchema,
    board: ActionDataBoardSchema,
    list: ActionDataListSchema.optional(),
    listBefore: ActionDataListSchema.optional(),
    listAfter: ActionDataListSchema.optional(),
  }),
  type: z.enum(['updateCard']),
  date: z.coerce.date(),
...
export type ActionUpdateCard = z.infer<typeof ActionUpdateCardSchema>;
