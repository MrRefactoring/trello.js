...
export const ActionAddMemberToBoardSchema = apiObject({
  id: z.string(),
  idMemberCreator: z.string(),
  data: apiObject({
    memberType: z.string(),
    idMemberAdded: z.string(),
    board: ActionDataBoardSchema,
  }),
  type: z.enum(['addMemberToBoard']),
  date: z.coerce.date(),
...
export type ActionAddMemberToBoard = z.infer<typeof ActionAddMemberToBoardSchema>;
