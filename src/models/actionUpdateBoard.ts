...
import { ActionDataBoardOldSchema } from '#/models/actionDataBoardOld';
import { LimitsSchema } from '#/models/limits';
import { MemberSchema } from '#/models/member';

export const ActionUpdateBoardSchema = apiObject({
  id: z.string(),
  idMemberCreator: z.string(),
  data: apiObject({
    board: ActionDataBoardSchema,
    old: ActionDataBoardOldSchema,
  }),
  type: z.enum(['updateBoard']),
  date: z.coerce.date(),
...
export type ActionUpdateBoard = z.infer<typeof ActionUpdateBoardSchema>;
