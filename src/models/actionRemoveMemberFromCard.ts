...
export const ActionRemoveMemberFromCardSchema = apiObject({
  id: z.string(),
  ...
  type: z.enum(['removeMemberFromCard']),
  date: z.coerce.date(),
...
export type ActionRemoveMemberFromCard = z.infer<typeof ActionRemoveMemberFromCardSchema>;
