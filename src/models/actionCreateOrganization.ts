...
export const ActionCreateOrganizationSchema = apiObject({
  id: z.string(),
  ...
  type: z.enum(['createOrganization']),
  date: z.coerce.date(),
...
export type ActionCreateOrganization = z.infer<typeof ActionCreateOrganizationSchema>;
