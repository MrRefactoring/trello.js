...
export const ActionMakeAdminOfBoardSchema = apiObject({
  id: z.string(),
...
export type ActionMakeAdminOfBoard = z.infer<typeof ActionMakeAdminOfBoardSchema>;
