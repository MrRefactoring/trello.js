...
export const ActionAddChecklistToCardSchema = apiObject({
  id: z.string(),
  ...
  type: z.enum(['addChecklistToCard']),
  date: z.coerce.date(),
...
export type ActionAddChecklistToCard = z.infer<typeof ActionAddChecklistToCardSchema>;
