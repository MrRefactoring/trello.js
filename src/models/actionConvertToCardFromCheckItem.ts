...
export const ActionConvertToCardFromCheckItemSchema = apiObject({
  id: z.string(),
  ...
  data: apiObject({
    ...
    cardSource: ActionDataCardSchema,
  }),
  type: z.enum(['convertToCardFromCheckItem']),
  date: z.coerce.date(),
...
export type ActionConvertToCardFromCheckItem = z.infer<typeof ActionConvertToCardFromCheckItemSchema>;
