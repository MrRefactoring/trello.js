...
export const ActionRemoveChecklistFromCardSchema = apiObject({
  id: z.string(),
  ...
  type: z.enum(['removeChecklistFromCard']),
  date: z.coerce.date(),
...
export type ActionRemoveChecklistFromCard = z.infer<typeof ActionRemoveChecklistFromCardSchema>;
