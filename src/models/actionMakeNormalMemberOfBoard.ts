...
export const ActionMakeNormalMemberOfBoardSchema = apiObject({
  id: z.string(),
  ...
  type: z.enum(['makeNormalMemberOfBoard']),
  date: z.coerce.date(),
...
export type ActionMakeNormalMemberOfBoard = z.infer<typeof ActionMakeNormalMemberOfBoardSchema>;
