...
export const ActionDeleteAttachmentFromCardSchema = apiObject({
  id: z.string(),
  ...
  type: z.enum(['deleteAttachmentFromCard']),
  date: z.coerce.date(),
...
export type ActionDeleteAttachmentFromCard = z.infer<typeof ActionDeleteAttachmentFromCardSchema>;
