...
import { ActionDataCardSchema } from '#/models/actionDataCard';
import { ActionDataChecklistSchema } from '#/models/actionDataChecklist';
import { ActionDataCheckItemSchema } from '#/models/actionDataCheckItem';
import { LimitsSchema } from '#/models/limits';
import { MemberSchema } from '#/models/member';

export const ActionUpdateCheckItemStateOnCardSchema = apiObject({
  id: z.string(),
  idMemberCreator: z.string(),
  data: apiObject({
    board: ActionDataBoardSchema,
    card: ActionDataCardSchema,
    checklist: ActionDataChecklistSchema,
    checkItem: ActionDataCheckItemSchema,
  }),
  type: z.enum(['updateCheckItemStateOnCard']),
  date: z.coerce.date(),
...
export type ActionUpdateCheckItemStateOnCard = z.infer<typeof ActionUpdateCheckItemStateOnCardSchema>;
