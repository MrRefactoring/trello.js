...
export const ActionAddMemberToCardSchema = apiObject({
  id: z.string(),
...
export type ActionAddMemberToCard = z.infer<typeof ActionAddMemberToCardSchema>;
