...
import { ActionDataCustomFieldSchema } from '#/models/actionDataCustomField';
import { LimitsSchema } from '#/models/limits';
import { MemberSchema } from '#/models/member';

export const ActionCreateCustomFieldSchema = apiObject({
  id: z.string(),
  idMemberCreator: z.string(),
  data: apiObject({
    board: ActionDataBoardSchema,
    customField: ActionDataCustomFieldSchema,
  }),
  type: z.enum(['createCustomField']),
  date: z.coerce.date(),
...
export type ActionCreateCustomField = z.infer<typeof ActionCreateCustomFieldSchema>;
