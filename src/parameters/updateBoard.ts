...
export const UpdateBoardSchema = z.object({
  ...
  'prefs/permissionLevel': openEnum(['org', 'private', 'public']).optional(),
  ...
  'prefs/invitations': openEnum(['admins', 'members']).optional(),
  /** Who can vote on this board. One of disabled, members, observers, org, public */
  'prefs/voting': openEnum(['disabled', 'members', 'observers', 'org', 'public']).optional(),
  /** Who can comment on cards on this board. One of: disabled, members, observers, org, public */
  'prefs/comments': openEnum(['disabled', 'members', 'observers', 'org', 'public']).optional(),
  /** The id of a custom background or one of: blue, orange, green, red, purple, pink, lime, sky, grey */
  'prefs/background': openEnum(['blue', 'orange', 'green', 'red', 'purple', 'pink', 'lime', 'sky', 'grey']).optional(),
  /** One of: pirate, regular */
  'prefs/cardAging': openEnum(['pirate', 'regular']).optional(),
