...
export const UpdateBoardSchema = z.object({
  ...
  'prefs/permissionLevel': z.union([z.string(), openEnum(['org', 'private', 'public'])]).optional(),
  ...
  'prefs/invitations': z.union([z.string(), openEnum(['admins', 'members'])]).optional(),
  /** Who can vote on this board. One of disabled, members, observers, org, public */
  'prefs/voting': z.union([z.string(), openEnum(['disabled', 'members', 'observers', 'org', 'public'])]).optional(),
  /** Who can comment on cards on this board. One of: disabled, members, observers, org, public */
  'prefs/comments': z.union([z.string(), openEnum(['disabled', 'members', 'observers', 'org', 'public'])]).optional(),
  /** The id of a custom background or one of: blue, orange, green, red, purple, pink, lime, sky, grey */
  'prefs/background': z
    .union([z.string(), openEnum(['blue', 'orange', 'green', 'red', 'purple', 'pink', 'lime', 'sky', 'grey'])])
    .optional(),
  /** One of: pirate, regular */
  'prefs/cardAging': z.union([z.string(), openEnum(['pirate', 'regular'])]).optional(),
