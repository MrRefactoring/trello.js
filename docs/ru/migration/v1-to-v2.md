...
> Изменено в **v3**: несовпадение больше не бросает исключение по умолчанию — о нём сообщается один раз, а тело возвращается невалидированным. См. [v2 → v3](/ru/migration/v2-to-v3).
